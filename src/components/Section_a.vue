  ...
  <div class="container w-75 pt-5">
    ...
    <div class="text-center">
      <ul>
        ...
        <li class="pb-3"><h3><strong>Meet The New Agency SEO Template From The Avada Team</strong></h3></li>
        <li><p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p></li>
      </ul>
    </div>
</div>
...
<img src="../assets/images/agency-seo-desk-front-1200x570.jpg" alt="">
</div>
</section>
